...
Para Iniciar : 
- Caso use Libs baixe o java-certificado-2.7.jar (https://github.com/Samuel-Oliveira/Java_Certificado/raw/master/java_certificado-2.7.jar) e o adicione às bibliotecas de Seu Projeto.
