...
Para Iniciar : 
- Caso use Libs baixe o java-certificado-2.2.jar (https://github.com/Samuel-Oliveira/Java_Certificado/raw/master/java-certificado-2.2.jar) e o adicione às bibliotecas de Seu Projeto.
